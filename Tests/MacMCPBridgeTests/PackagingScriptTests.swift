...
final class PackagingScriptTests: XCTestCase {
    ...
    func testPinnedMailBuildScriptVerifiesTheSourceAndGoDependencyGraph() throws {
        ...
        XCTAssertTrue(script.contains("MAIL_VERSION=\"v1.2.3\""))
        XCTAssertTrue(script.contains("MAIL_COMMIT=\"33b95d571ae7b55c7caffa4f2a5fae1e2755b424\""))
    ...
    func testPackagedVersionsMatchTheNextSourceRelease() throws {
        ...
        XCTAssertTrue(appVersion.contains("static let version = \"0.2.15\""))
        XCTAssertTrue(appInfo.contains("<string>0.2.15</string>"))
        XCTAssertEqual(bundleInfo.components(separatedBy: "<string>0.2.15</string>").count, 3)
    }
