...
final class PackagingScriptTests: XCTestCase {
    ...
    func testPackagedVersionsMatchTheNextSourceRelease() throws {
        ...
        XCTAssertTrue(appVersion.contains("static let version = \"0.2.12\""))
        XCTAssertTrue(appInfo.contains("<string>0.2.12</string>"))
        XCTAssertEqual(bundleInfo.components(separatedBy: "<string>0.2.12</string>").count, 3)
    }
