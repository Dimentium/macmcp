...
final class PackagingScriptTests: XCTestCase {
    ...
    func testPackagedVersionsMatchTheNextSourceRelease() throws {
        ...
        XCTAssertTrue(appVersion.contains("static let version = \"0.2.30\""))
        XCTAssertTrue(appInfo.contains("<string>0.2.30</string>"))
        XCTAssertEqual(bundleInfo.components(separatedBy: "<string>0.2.30</string>").count, 3)
    }
